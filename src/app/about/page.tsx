		...
		<Script
			...
			dangerouslySetInnerHTML={{
				__html: JSON.stringify({
					...
					"@type": "WebPage",
					name: "About Auction Market SA",
					url: "https://auctionmarket.tech/about",
					description:
						"Learn about Auction Market SA, South Africa’s most innovative digital auction platform for real-time, secure, and modern online auctions.",
					publisher: {
						"@type": "Organization",
			...
			<Container>
				...
				<div className={styles.content}>
					...
					<section className={`${styles.section} ${styles.span2}`}>
						...
						<p>
							<b>Auction Market SA</b> is South Africa’s most innovative digital
							auction platform, built to connect buyers and sellers in a seamless,
							transparent, and secure environment. We are proudly South African,
							focused on empowering local communities, businesses, and individuals to
							participate in the digital economy through real-time auctions.
						</p>
						<p>
							...
							offer a wide range of auction categories, including electronics,
							vehicles, collectibles, property, and more. With our advanced
							technology, you can bid, win, and pay securely from anywhere in South
							Africa.
						</p>
						<p>
							We believe in <b>fairness</b>, <b>accessibility</b>, and{" "}
							<b>community</b>. Our mission is to make auctions easy, fun, and
							rewarding for all South Africans, while supporting local sellers and
							promoting economic growth.
						</p>
						<p>
							Whether you’re looking for a bargain, a rare collectible, or a new way
							to sell your goods, Auction Market SA is your trusted partner in the
					...
					<section className={styles.section}>
						...
						<ul className={styles.features}>
							...
							<li>
								...
								<span>
									<b>Secure & Trusted:</b> Your data and payments are protected
									with industry-leading security and PayFast integration.
								</span>
							</li>
							<li>
							...
							<li>
								...
								<span>
									<b>Mobile Ready:</b> Bid and win from anywhere with our
									responsive web app and mobile downloads.
								</span>
							</li>
						</ul>
					</section>
					<section className={`${styles.section} ${styles.spanRow2}`}>
						...
						<p>
							Our mission is to make auctions accessible, transparent, and enjoyable
							for everyone in South Africa. We believe in fair play, innovation, and
							empowering our users—whether you&apos;re a first-time bidder or a
							seasoned seller.
						</p>
					</section>
					<section className={styles.section}>
